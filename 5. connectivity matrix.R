...
for (j in 1:1) {
  ...
  list.files()
  dir.create(paste0("/Volumes/1TB Bob/sp by farm/super pulse RDS files/heatmap"))
...
p1
setwd("/Volumes/1TB Bob/sp by farm/super pulse RDS files/heatmap")
ggsave(paste0("sp",j, ".png"), plot = p1)
}
